...
<p>
    ...
    <?if(Theme::get('premium')!=1):?>
        <a class="btn btn-info btn-xs" style="display:hidden" target="_blank" href="http://forums.open-classifieds.com/"><i class="glyphicon glyphicon-wrench"></i> <?=__('Forum')?></a>
    <?else:?>
    ...
    <?endif?>
    <a class="btn btn-info btn-xs" style="display:hidden"  target="_blank" href="http://open-classifieds.com/support/"><i class="glyphicon glyphicon-question-sign"></i> <?=__('FAQ')?></a>
    <a class="btn btn-info btn-xs" style="display:hidden"   target="_blank" href="http://open-classifieds.com/blog/"><i class="glyphicon glyphicon-pencil"></i> <?=__('Blog')?></a>
</p>
