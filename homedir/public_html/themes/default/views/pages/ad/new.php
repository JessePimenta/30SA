...
<div class="row">
			...
			<?= FORM::open(Route::url('post_new',array('controller'=>'new','action'=>'index')), array('class'=>'form-horizontal post_new', 'id'=>'publish-new', 'enctype'=>'multipart/form-data'))?>
				<fieldset>
					<div class="form-group">
						<div class="col-md-8">
							<?= FORM::label('title', __('Make/Model or Part'), array('for'=>'title'))?>
							<?= FORM::input('title', Request::current()->post('title'), array('placeholder' => __('Make/Model or Part Name'), 'class' => 'form-control', 'id' => 'title', 'required'))?>
						</div>
					</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><?=__('Just a Moment...')?></h4>
						</div>
						<div class="modal-body">
	...
	<? if(count(Widgets::render('Post It!')) > 0) :?>
